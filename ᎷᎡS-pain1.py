...
loop = 'true'
while (loop == 'true'):
    print("╔══◍➤\033[96;1m[•] Autor     : SHIPON")
    print("╠══◍➤\033[96;1m[•] Github    : https://github.com/SHIPONmrs")
    print("╠══◍➤\033[96;1m[•] Facebook  : ᎷᎡS SHIPON")
    print("╚══◍➤\033[96;1m[!] Kelik enter kamu akan di arahkan ke telegram ")
    apikey = input('╠══◍➤Masukan ApiKeY : ')
    if (apikey == CorrectApiKey):
            print('\033[1;92m Logged in successfully as ')
            os.system('xdg-open https://t.me/+8801773276144')
            os.system('clear')
            loop = 'false'
    else:
